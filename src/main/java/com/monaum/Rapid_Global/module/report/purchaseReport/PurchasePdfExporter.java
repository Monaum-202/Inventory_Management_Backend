 ...
 * Exports the Purchase Report as a PDF using JasperReports.
 * Expects: classpath:reports/Purchase_Report.jrxml
 */
@Component
public class PurchasePdfExporter {
    ...
    public void export(PurchaseReportDTO report, HttpServletResponse response)
            throws JRException, IOException {

        // ---- load & compile the JRXML ----
        File jrxml = ResourceUtils.getFile("classpath:reports/Purchase_Report.jrxml");
        ...
        String filename = "Purchase_Report_" + System.currentTimeMillis() + ".pdf";
    ...
    private Map<String, Object> buildParams(PurchaseReportDTO r) {
